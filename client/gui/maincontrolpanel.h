...
class MainControlPanel : public QWidget
{
	...
	static const QSize B_PLAY_SIZE=QSize(60, 60);
	static const QPoint B_PLAY_POINT=QPoint(5, 60);
	
	static const QSize B_STOP_SIZE=QSize(40, 40);
	static const QPoint B_STOP_POINT=QPoint(70, 75);

	

	static const QSize B_PREV_SIZE=QSize(40, 40);
	static const QPoint B_PREV_POINT=QPoint(115, 75);

	static const QSize B_NEXT_SIZE=QSize(40, 40);
	static const QPoint B_NEXT_POINT=QPoint(160, 75);
